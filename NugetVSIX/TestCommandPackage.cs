...
namespace NugetVSIX
{
    ...
    [ProvideToolWindow(typeof(CustomToolWindow))]
    public sealed class TestCommandPackage : Package
    {
        /// <summary>
        /// TestCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "0d1a842c-0099-4678-924f-5e37ee2a51a0";
        ...
        protected override void Initialize()
        {
            ...
            base.Initialize();
            CustomToolWindowCommand.Initialize(this);
        }
